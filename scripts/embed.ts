...
import { projectToEmbeddingText } from "../src/lib/retrieval/project-text";
import { embedTexts } from "../src/lib/retrieval/embed";
...
async function applyVectorIndex() {
  ...
  const sql = readFileSync(
    join(process.cwd(), "supabase/migrations/002_vector_index.sql"),
    "utf8"
  );
